...
import static library.assistant.ui.login.LoginController.member;
...
public class MainController implements Initializable, BookReturnCallback {
    ...
    @FXML
    private void handleMenuAddEmployee(ActionEvent event) {
        LibraryAssistantUtil.loadWindow(getClass().getResource("/library/assistant/ui/addemployee/employee_add.fxml"), "Add New Employee", null);
    }
